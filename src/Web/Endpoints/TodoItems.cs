using WeatherApp.Application.Common.Models;
using WeatherApp.Application.TodoItems.Commands.CreateTodoItem;
using WeatherApp.Application.TodoItems.Commands.DeleteTodoItem;
using WeatherApp.Application.TodoItems.Commands.UpdateTodoItem;
using WeatherApp.Application.TodoItems.Commands.UpdateTodoItemDetail;
using WeatherApp.Application.TodoItems.Queries.GetTodoItemsWithPagination;
